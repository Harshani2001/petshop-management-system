...
public class sellItems extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 58, 230, 690));

        sellTable.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        sellTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Sales ID", "Dog ID", "Dog Name", "Dog Value", "Qty of Dogs", "Total", "Date"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 150, 1090, 580));
        ...
        jPanel1.add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 88, 260, 40));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel7.setText("Search here :");
        jPanel1.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 90, -1, -1));

        jPanel8.setBackground(new java.awt.Color(0, 255, 0));

        jLabel6.setFont(new java.awt.Font("Microsoft YaHei", 1, 36)); // NOI18N
        jLabel6.setText("Dogs Sales Window");
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {                                    
       try{
        ...
        ResultSet rs = st.executeQuery("select * from selltbl");
